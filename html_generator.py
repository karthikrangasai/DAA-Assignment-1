...
def generate_html(filename):
	with open(filename, 'w') as file:
		...
		file.write("\t\t\t<h1>CS F364 - Design and Analysis of Algorithms - Assignment 1</h1>\n")
		...
		file.write("\t\t\t<div><div><h1>Time Analysis of our Code</h1></div></div>\n")
		file.write("\t\t\t<div><img src=\"./time_analysis/time_analysis_4000_points.png\" style=\"width: 100%;\"></div>\n")
		file.write("\t\t</div>\n")

		file.write("\t\t<div class=\"section\">\n")
		file.write("\t\t\t<div style=\"text-align: center;margin: 5px 0;\"><h1>Contour Visualisations</h1></div>\n")

		# For loop here
		for image_filename in ["simple", "bars", "smiley", "saitama", "pikachu"]:
			file.write("\t\t\t<div class=\"sub-section\">\n")
			file.write("\t\t\t\t<div class=\"diagram-div-img\"><img src=\"./output_visualisations/images/" + image_filename + ".png\"></div>\n")
			file.write("\t\t\t\t<div class=\"diagram-div-text\">\n")
			file.write("\t\t\t\t\t<div><h1>" + image_filename.title() + " Shape Visualisation</h1></div>\n")
			file.write("\t\t\t\t\t<div>\n")
			file.write("\t\t\t\t\t\t<ul>\n")
			with open("./output_visualisations/outputs/" + image_filename + "_details.txt") as f:
				l = f.readline().split(' ')
				file.write("\t\t\t\t\t\t\t<li>Number of Rectangles: " + l[0] + "</li>\n")
				file.write("\t\t\t\t\t\t\t<li>Measure: " + l[1] + "</li>\n")
				file.write("\t\t\t\t\t\t\t<li>Time taken: " + l[2] + "microseconds</li>\n")
			file.write("\t\t\t\t\t\t</ul>\n")
			file.write("\t\t\t\t\t</div>\n")
			file.write("\t\t\t\t</div>\n")
			file.write("\t\t\t</div>\n")
		...
		file.write("\t\t\t<div>\n")
		file.write("\t\t\t\t<ul>\n")
		file.write("\t\t\t\t\t<li>- Maintaining lower constant in Linear Complexity for Merge function.</li>\n")
		file.write("\t\t\t\t\t<li>- Generation of random testcases for stress testing and checking correctness of program.</li>\n")
		file.write("\t\t\t\t\t<li>- Careful generation of testcases for aesthetic outputs.</li>\n")
		file.write("\t\t\t\t</ul>\n")
		file.write("\t\t\t</div>\n")
		file.write("\t\t</div>\n")
		...
		file.write("\t\t\t\t<ul>\n")
		file.write("\t\t\t\t\t<li><a href=\"https://link.springer.com/article/10.1007/BF00264251#citeas\">Guting, R.H. Optimal divide-and-conquer to compute measure and contour for a set of iso-rectangles.</a></li>")
		file.write("\t\t\t\t</ul>\n")
		file.write("\t\t\t</div>\n")
		file.write("\t\t</div>\n")
...
if __name__ == "__main__":
	...
	parser.add_argument('-f', '--file', type=str, required=True, help='Path to output html file')
