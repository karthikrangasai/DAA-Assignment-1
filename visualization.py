...
def main(input_file_path, output_file_path):
    with open(input_file_path, 'r') as file:
        ...
        for line in range(n_recs):
            ...
            plt.plot([x2, x2], [y1, y2], color='red', linewidth=1)
            plt.plot([x1, x2], [y1, y1], color='red', linewidth=1)
    ...
    with open(output_file_path, 'r') as file:
        ...
        for line in file:
            ...
            if len(line.split()) == 1:
                ...
                if isY is False:
                    plt.plot([points[0], points[1]], [points[2], points[2]], color='green', linewidth=3) # x1 x2 y
                else:
                    plt.plot([points[2], points[2]], [points[0], points[1]], color='green', linewidth=3) # y1 y2 x
